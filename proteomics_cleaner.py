...
class ProteomicsCleaner:
    ...
    def calculate_quality_metrics(self) -> Dict:
        ...
        # Save results
        self._save_quality_results(stats, problematic, outlier_data)
    ...
    def _save_quality_results(self, stats, problematic, outlier_data):
        """
    ...
    def _create_overview_plots(self, viz_dir, stats, problematic):
        ...
        plt.subplot(2, 2, 3)
        sns.histplot(
            pd.to_numeric(stats["iqr_outlier_pct"].clip(0, 20), errors="coerce"),
            kde=True,
        )
